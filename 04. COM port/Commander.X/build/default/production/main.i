...
# 1 "./utils.h" 1
# 16 "./utils.h"
    void readline(char *str, _Bool password);
# 50 "main.c" 2
# 1 "./auth.h" 1
...
_Bool isauthorized(void);

_Bool validate(char username[], char password[]);

_Bool login(char username[], char password[]);
# 51 "main.c" 2
# 1 "./timer.h" 1
# 15 "./timer.h"
    ...
    void timer_write(int display, char input, _Bool dot);
...
void temperature_monitor(_Bool timer) {
    _Bool ready = 0;
