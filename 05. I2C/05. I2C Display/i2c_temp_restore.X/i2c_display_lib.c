/*
 * Includering af filer som skal bruges
 */
#include "mcc_generated_files/mcc.h" // Eller kløjs compiler og/eller IDE
//#include "i2c_display_spec_chars.h"
...
/*
 *  I opstart af LCD, laver vi følgende konfiguration:
 */
void i2c_display_init(void) {
    i2c_display_write_inst(0x01); // 1. Clear Display kommando    

    // 2. Function set:  00001
    //    DL = 1; 8-bit interface data
    //    N  = 0; 1-line display
    //    F  = 0; 5x8 dot character font    
    i2c_display_write_inst(0x38); // DL=1: 8 bits; N=1: 2 line; F=0: 5 x 8 dots - 0b0011 1000?
    
    // 3. Display on/off control:
    //    D = 0; Display off
    //    C = 0; Cursor off
    //    B = 0; Blinking off    
    i2c_display_write_inst(0x0E); // D=1, display on; C=B=0: cursor off; blinking: off;
...
void i2c_display_write_data(uint8_t byData) {
  i2c_set_start_condition(); // Initialiser I2C bussen
